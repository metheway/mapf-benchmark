...
public class MACBSNodeR extends State {
    ...
    public MACBSNodeR(State backPointer, CBSConstraint constraint, List<List<Integer>> metaAgents) {
        super(backPointer);
        this.metaAgents = metaAgents;
        this.constraint = constraint;
        this.solutions = new ArrayList<>(((MACBSNodeR) predecessor()).solutions);
    }

    public MACBSNodeR(ProblemInstance problemInstance, ConstrainedSolver solver, List<List<Integer>> metaAgents) {
        super(null);
...
*/
    ...
    private void populateConstraints() {
        ...
        while (current != null) {
            ...
            current = (MACBSNodeR) current.predecessor();
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        MACBSNodeR macbsNode = (MACBSNodeR) o;
    ...
    public List<State> expand(ProblemInstance problem) {
        ...
        neighbors.add(new MACBSNodeR(this, constraint1, metaAgents));
        neighbors.add(new MACBSNodeR(this, constraint2, metaAgents));
